                    ...
                    <div class="repo-item">
                        ...
                        <div class="repo-content">
                            ...
                            <div class="repo-meta">
                                ...
                                <div class="repo-updated">
                                    <span>Updated ${{formatDate(updatedAt)}} <a href=${{screenshotUrl}} target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">🏞</a><a href=${{screenshotUrlRC}} target="_blank" rel="noopener noreferrer" style="text-decoration: none; color: inherit;">📸</a></span>
                                </div>
                            </div>
                        </div>
                    </div>
